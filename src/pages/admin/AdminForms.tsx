...
import { Plus, Link as LinkIcon, Edit2, Trash2, ExternalLink, Loader2, FileText, CheckCircle2, XCircle } from 'lucide-react';
            ...
            <div className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm">
                {loading ? (
                    ...
                    <div className="divide-y divide-border">
                        {forms.map(form => (
                            <div key={form.id} className="p-5 hover:bg-muted/20 transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4 group">
