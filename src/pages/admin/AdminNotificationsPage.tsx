...
const AdminNotificationsPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const channel = supabase.channel('admin-personal-notifications')
            .on('postgres_changes', {
                event: '*',
                schema: 'public',
                table: 'notifications',
        ...
        <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage and review your personal security alerts and updates</p>
                </div>
