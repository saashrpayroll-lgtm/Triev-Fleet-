...
${pitch.whatsappEnglish}`;
    ...
    return (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-[20000] flex items-end md:items-center justify-center p-0 md:p-4 animate-in fade-in duration-200">
