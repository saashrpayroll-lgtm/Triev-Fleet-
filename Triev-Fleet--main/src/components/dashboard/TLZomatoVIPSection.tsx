...
interface TLZomatoVIPSectionProps {
    stats: {
        zomatoTotal: number;
...
const TLZomatoVIPSection: React.FC<TLZomatoVIPSectionProps> = ({ stats, onNavigate }) => {
    ...
    if (stats.zomatoTotal === 0) return null;
                ...
                <div className="relative z-10 flex flex-col lg:flex-row gap-4 lg:gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                                <h3 className="text-xs font-black uppercase tracking-wider text-orange-600 dark:text-orange-400">My VIP Fleet</h3>
                        ...
                        <div className="grid grid-cols-3 gap-2 sm:gap-3">
                            ...
                            <motion.div
                                ...
                                onClick={() => onNavigate('/team-leader/riders', { filter: 'zomato' })}
...
export default TLZomatoVIPSection;
