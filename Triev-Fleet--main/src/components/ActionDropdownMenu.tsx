...
const ActionDropdownMenu: React.FC<ActionDropdownMenuProps> = ({
    ...
    onReassign, onRestore, onPermanentDelete, onAdjustWallet, onElevenLabsCall,
    userRole,
    ...
    const MenuItems = () => (
        <div className="py-1 px-1 space-y-0.5">
            ...
            {!isDeleted && onElevenLabsCall && rider.status === 'active' && Number(rider.walletAmount || 0) < 250 && (
                <button onClick={act(onElevenLabsCall)} className="w-full px-3 py-2.5 text-left hover:bg-violet-500/10 hover:text-violet-600 rounded-lg transition-colors flex items-center gap-3 group text-sm font-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-muted-foreground group-hover:text-violet-600"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/><path d="M14.05 2a9 9 0 0 1 8 7.94" opacity="0.5"/><path d="M14.05 6A5 5 0 0 1 18 10" opacity="0.7"/></svg>
                    AI Voice Call
                </button>
            )}
